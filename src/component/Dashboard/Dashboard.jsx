...
import Tabs from './Holdings/Tabs';
                                ...
                                <div className="flex flex-wrap justify-center">
                                    ...
                                    <div className="w-full lg:w-4/12 px-4 lg:order-3 lg:text-right lg:self-center">
                                        <div className="py-6 px-3 mt-32 sm:mt-0">
                                            ...
                                            <a
                                                className="bg-black active:bg-black uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1"

                                                style={{ transition: "all .15s ease" }}
                                                href="http://localhost:3000/0x33942C2eDA77EB45B8420F86E9f2f8d97f127883"
                                            >
                                                Chat
                                            </a>
                                        </div>
